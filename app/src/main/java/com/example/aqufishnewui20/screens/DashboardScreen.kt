...
@Composable
fun MainPageDashboard(navController: NavHostController){
...
@Composable
fun TopBottomBar(navController: NavHostController){
    ...
    Column(
        ...
        UserAndFeederDetails()
        FeederOptions(navController)
    }
...
@Composable
fun UserAndFeederDetails(viewModel: MainViewModel = viewModel()) {
...
@Composable
fun CardDetails(ipAddress: String, navController: NavHostController, duration: Int, dailyFeedWeight: Float, totalFeedWeight: Float){
        ...
        LazyColumn {
            items(5) { ipAddress ->
                Row(
                    ...
                    CardDetails(null.toString(), duration = 60, dailyFeedWeight = 100f, totalFeedWeight = 200f,navController=navController)
                }
            }
        }
    }
